        ...
        'https://www.googleapis.com/youtube/v3/playlistItems', {
            ...
            function(data){
                ...
                $.each(data.items, function(i, item){
                    ...
                    output = '<li><a class="no-barba" href="https://youtu.be/'+videoId+'" target="_blank" data-videoId="'+videoId+'"><img src="'+item.snippet.thumbnails.large.url+'" alt=""><span class="videoTitle">'+videoTitle+'</span>'+ videoDescription+'</a></li>';
                    console.log(output);
