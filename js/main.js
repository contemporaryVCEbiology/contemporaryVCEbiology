...
function displayVids(data){
    ...
    $.each(data.items, function(i, item){
        ...
        output = '<li><a class="no-barba" href="https://youtu.be/'+videoId+'" data-videoId="'+videoId+'"><img src="'+item.snippet.thumbnails.medium.url+'" alt=""><span class="videoTitle">'+videoTitle+'</span>'+ videoDescription+'</a></li>';
        //console.log(output);
...
function vidLinks(){
    $('#results').on( 'click', 'li a', function() {
        ...
        $('.overlay').append('<div class="videoWrapper"><iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/'+videoId+'?rel=0" frameborder="0" allow="autoplay" allow="encrypted-media" allowfullscreen></iframe></div>').addClass('on');
    });
